...
import { FaUsers, FaBuilding, FaUtensils, FaSignOutAlt, FaUser } from 'react-icons/fa';
        ...
        <div style={{ display: 'flex' }}>
          ...
          >
            <List>
              ...
              <ListItem button onClick={() => navigate('/searchvenues')}>
                <ListItemIcon><FaBuilding /></ListItemIcon>
                <ListItemText primary="Venue Search" />
              </ListItem>
            </List>
            {isAuthenticated && (
          ...
          <main className="main">
            <Routes>
              ...
              <Route path="/searchvenues" element={isAuthenticated ? <VenueSearch /> : <Navigate to="/login" />} />
